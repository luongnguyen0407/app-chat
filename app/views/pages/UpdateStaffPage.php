    ...
    <form action="./AddStaff/Add" method="POST" class="form_add" enctype="multipart/form-data">
        ...
        <div class="field_form from_name">
            <div class="one_column_input ">
                ...
                <input class="util_input" type="text" name="name" id="name" value="<?= PrintDisplay::printValue($data, 'ho_ten') ?>">
                <p class="error_from"><?php PrintDisplay::printError($data, 'name') ?></p>
            </div>
            <div class="one_column_input ">
                <label for="phone">Số điện thoại</label>
                <input class="util_input" type="text" name="phone" id="phone" value="<?= PrintDisplay::printValue($data, 'so_dien_thoai') ?>">
        ...
        <div class="field_form from_name">
            ...
            <div class="one_column_input ">
                ...
                <input class="util_input" type="date" name="sinh_nhat" id="birthday" value="<?= PrintDisplay::printValue($data, 'ngay_sinh') ?>">
        ...
        <div class="field_form from_name">
            <div class="one_column_input ">
                ...
                <input class="util_input" type="text" name="hop_dong_id" id="hopdongid" value="<?= PrintDisplay::printValue($data, 'so_hop_dong') ?>">
                <p class="error_from"><?php PrintDisplay::printError($data, 'hop_dong_id') ?></p>
            </div>
            <div class="one_column_input ">
                <label for="phone">Lương Cứng (VND)</label>
                <input class="util_input" type="text" name="salary" id="salary" value="<?= PrintDisplay::printValue($data, 'luong_cung') ?>">
                <p class="error_from"><?php PrintDisplay::printError($data, 'salary') ?></p>
            </div>
            <div class="one_column_input ">
                <label for="date_start">Ngày bắt đầu(Hợp đồng)</label>
                <input class="util_input" type="date" name="date_start" id="date_start" value="<?= PrintDisplay::printValue($data, 'ngay_bat_dau') ?>">
                <p class="error_from"><?php PrintDisplay::printError($data, 'date_start') ?></p>
            </div>
            <div class="one_column_input ">
                <label for="date">Ngày kết thúc(Hợp đồng)</label>
                <input class="util_input" type="date" name="date_end" id="date_end" value="<?= PrintDisplay::printValue($data, 'ngay_ket_thuc') ?>">
